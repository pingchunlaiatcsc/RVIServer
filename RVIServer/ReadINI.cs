...
namespace prjTCP_ChatRoomServer
{
    public class ReadINI : IDisposable
    {
        ...
        public string getKeyValue(string IN_Section, string IN_Key)
        {
            ...
            int i = GetPrivateProfileString(IN_Section, IN_Key, "", temp, 2000, this._FilePath);
        ...
        public string getKeyValue(string Section, string Key, string DefaultValue)
        {
            ...
            try
            {
                sbResult = new StringBuilder(2000);
                GetPrivateProfileString(Section, Key, "", sbResult, 2000, this._FilePath);
